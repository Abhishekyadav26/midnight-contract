...
export class Contract {
    ...
    constructor(...args_0) {
        ...
        this.circuits = {
            attend_event: (...args_1) => {
                if (args_1.length !== 1) {
                    throw new __compactRuntime.CompactError(`attend_event: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
                }
                const contextOrig_0 = args_1[0];
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('attend_event', 'argument 1 (as invoked from Typescript)', 'wallet.compact line 12 char 1', 'CircuitContext', contextOrig_0);
                }
                ...
                const result_0 = this._attend_event_0(context, partialProofData);
                partialProofData.output = { value: [], alignment: [] };
                return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
            }
        };
        this.impureCircuits = { attend_event: this.circuits.attend_event };
    }
    initialState(...args_0) {
        if (args_0.length !== 1) {
        ...
        state_0.setOperation('attend_event', new __compactRuntime.ContractOperation());
    ...
    _attend_event_0(context, partialProofData) {
        const tmp_0 = 1n;
        __compactRuntime.queryLedgerState(context, partialProofData, [
            { idx: { cached: false,
                    pushPath: true,
